...
export function SpecialText({
  ...
  }, [shouldAnimate, hasStarted, delay, text.length]) // eslint-disable-line
  ...
  }, [text, hasStarted]) // eslint-disable-line

  return (
    <span
      ref={containerRef}
      className={`leading-none inline-flex font-mono font-medium ${className}`}
    >
      {displayText}
    </span>
  )
